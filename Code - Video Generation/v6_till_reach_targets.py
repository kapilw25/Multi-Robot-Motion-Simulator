...
def animate_movement(initial_positions, final_positions, radius, file_name='animation.mp4'):
    fig, ax = plt.subplots()
    ax.set_xlim(0, 60)
    ax.set_ylim(0, 60)
...
def main():
    ...
    xlim = (0, 60)
    ylim = (0, 60)
    radius = 3.0    # Radius of the robots
    min_distance = 2 * radius # Minimum distance between robots
    ...
    animate_movement(initial_positions, final_positions, radius, 'v6_robots_movement.mp4')
